...
from .middleware import AsyncKiotaTransport, MiddlewarePipeline, ParametersNameDecodingHandler, RedirectHandler, RetryHandler
...
class KiotaClientFactory:
    ...
    def create_with_default_middleware(self) -> httpx.AsyncClient:
        ...
        kiota_async_client._transport = AsyncKiotaTransport(transport=current_transport, middleware=middleware)
